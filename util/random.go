...
func RandomMoney() string {
	return fmt.Sprintf("%d.%d", RandomInt(1, 1000), RandomInt(0, 99))
}

// RandomRate generates a random discount rate in decimal
func RandomRate() string {
	return fmt.Sprintf("%d.%d", RandomInt(0, 50), RandomInt(0, 99))
}